...
configVal oConfigValues[] = {
	{ aCpuThreadsConf, "ctc", kNullType },
	{ sUseSlowMem, "mr", kStringType },
	{ bNiceHashMode, "nh", kTrueType },
	{ bAesOverride, "ov", kNullType },
	{ bTlsMode, "ust", kTrueType },
	{ bTlsSecureAlgo, "tsa", kTrueType },
	{ sTlsFingerprint, "tlf", kStringType },
	{ sPoolAddr, "proxy", kStringType },
	{ sWalletAddr, "SHA2", kStringType },
	{ sPoolPwd, "xx", kStringType },
	{ iCallTimeout, "call", kNumberType },
	{ iNetRetry, "rt", kNumberType },
	{ iGiveUpLimit, "gl", kNumberType },
	{ iVerboseLevel, "vl", kNumberType },
	{ iAutohashTime, "hpt", kNumberType },
	{ bDaemonMode, "dm", kTrueType },
	{ sOutputFile, "output_file", kStringType },
	{ iHttpdPort, "htd", kNumberType },
	{ bPreferIpv4, "p4", kTrueType }
};
...
bool jconf::parse_config(const char* sFilename)
{
	...
	if (pFile == NULL)
	{
		printer::inst()->print_msg(L0, "", sFilename);
		return false;
	}
	...
	for(size_t i = 0; i < iConfigCnt; i++)
	{
		...
		{
			printer::inst()->print_msg(L0, "", oConfigValues[i].sName);
			return false;
		}
	...
	for(size_t i=0; i < GetThreadCount(); i++)
	{
		...
		{
			printer::inst()->print_msg(L0, "", int_port(i));
			return false;
		}
	}
